...
import TabsForDashboard from "views/Dashboard/TabsForDashboard.js"

const useStyles = makeStyles(styles);

class DashboardRender extends React.Component {
    constructor(props){
      super(props)
      this.state = {
        websites: [],
    ...
    render() {
        if (this.state.websites.length > 0) {
            return <TabsForDashboard data={this.state.websites}/>
        } else {
